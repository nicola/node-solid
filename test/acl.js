...
describe.skip('ACL HTTP', function() {
    this.timeout(10000);
    ...
    var testDirAclFile = testDir + '/' + suffixAcl;
    var testDirMetaFile = testDir + '/' + suffixMeta;

    var abcFile = testDir + '/abc.ttl';
    var abcAclFile = abcFile + suffixAcl;
    var abcdFile = testDir + '/dir1/dir2/abcd.ttl';
    var abcdAclFile = abcFile + suffixAcl;
    ...
    describe('Basic', function() {
        it.skip('Should return "Hello, World!"', function(done) {
