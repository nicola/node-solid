...
describe('HTTP APIs', function () {
  ...
  describe('PUT API', function () {
    ...
    it('Should create container if it does not exist', function (done) {
  ...
  describe('DELETE API', function () {
    it('Should return 404 status when deleting a file that does not exists', function (done) {
  ...
  describe('POST API', function () {
    ...
    it('Should be able to delete newly created resource', function (done) {
      server.delete('/' + postResourceName.replace(/https?\:\/\/localhost(:[0-9]*)?\//, ''))
        .expect(200, done)
    })
